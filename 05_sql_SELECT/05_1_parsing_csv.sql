[09:12] Peter Schmidt
/* Datenimport - csv mit ID *//* DB */
DROP DATABASE IF EXISTS stocks;
CREATE DATABASE IF NOT EXISTS stocks;/* Tabelle stocks*/DROP TABLE IF EXISTS stocks.ccc;CREATE TABLE IF NOT EXISTS stocks.ccc
(
...
);DESCRIBE stocks.ccc;-- CSV-Datei parsen
